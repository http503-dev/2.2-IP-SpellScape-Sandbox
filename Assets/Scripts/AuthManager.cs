...
public class AuthManager : MonoBehaviour
{
    ...
    private void SignUpUser(string email, string password)
    {
        ...
        auth.CreateUserWithEmailAndPasswordAsync(email, password).ContinueWithOnMainThread(task =>
        {
            ...
            else if (task.IsCompleted)
            {
                ...
                CreateNewUser(userId, emailUpField.text, "placeholder username", false, "Unknown", 0, new List<string>(), 0f, 0, 0, 0, "Unknown", "");
    ...
    private void CreateNewUser(string userId, string email, string username, bool adminStatus, string imageDifficultyLevel, int uniqueWords, List<string> uniqueWordsList, float fastestTimePerWord, int leastMistakes, int totalAttempts, int totalWordsPerAttempt, string challengeDifficultyLevel, string profilePicURL)
    {
        ...
        SandboxArea sandbox = new SandboxArea(uniqueWords, uniqueWordsList);
        ...
        User user = new User(email, username, adminStatus, imageTracking, sandbox, challenge, profilePicURL);
